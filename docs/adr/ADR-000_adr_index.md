...
| ADR-025 | Deterministic Feature Layer / PIT / Window / Missingness Contract（CR-5） | PROPOSED | 2026-09-03 | [ADR-025](ADR-025_feature_layer_pit_missingness.md)，CR-5 / CR-5.1 / CR-5.2；Amendment A：Registry honest execution、Feature seal cross-binding、active missingness 与 1..66 mapping；Amendment B：bounded selected-input lineage；Reviewer final closure pending |
