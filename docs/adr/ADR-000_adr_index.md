...
| ADR-023 | AvailabilityPolicy + Canonical Source Selection（时间可用性策略与 Canonical 源选择） | PROPOSED | 2026-09-01 | [ADR-023](ADR-023_availability_policy_canonical_selection.md)，CR-3（DM-20260901-068）+ CR-3.1 Amendment A（DM-20260901-069）+ CR-3.2 Amendment B（DM-20260901-070：transactional materialized snapshot / identity master PIT / honest policy execution / typed full seal + verification-state transition）；复审裁决 pending |
