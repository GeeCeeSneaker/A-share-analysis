...
| ADR-023 | AvailabilityPolicy + Canonical Source Selection（时间可用性策略与 Canonical 源选择） | PROPOSED | 2026-09-01 | [ADR-023](ADR-023_availability_policy_canonical_selection.md)，CR-3（DM-20260901-068）+ CR-3.1 Amendment A（DM-20260901-069）+ CR-3.2 Amendment B（DM-20260901-070）+ CR-3.3 Amendment C（DM-20260902-071：historical input continuity guard / verification evidence exactness / finding truthfulness / seal count correction）+ CR-3.4 Amendment D（DM-20260902-072：historical canonical seal trust / verification replay symmetry / manifest correctness identity binding；无新 migration）+ CR-3.5 Amendment E（DM-20260902-073：tamper-resistant historical candidate discovery / derived canonical run seal 物理闭环 / status semantic seal；无新 migration）；复审裁决 pending |
