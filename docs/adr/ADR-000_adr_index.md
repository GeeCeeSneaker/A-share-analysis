...
| ADR-023 | AvailabilityPolicy + Canonical Source Selection（时间可用性策略与 Canonical 源选择） | PROPOSED | 2026-09-01 | [ADR-023](ADR-023_availability_policy_canonical_selection.md)，CR-3（DM-20260901-068）+ CR-3.1 Amendment A（DM-20260901-069：requested domain set identity / CanonicalInputSnapshot / anchored availability evidence / identity policy binding / full-field policy hash / full replay seal / recoverable commit）；复审裁决 pending |
