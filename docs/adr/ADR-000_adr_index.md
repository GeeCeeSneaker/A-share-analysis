...
| ADR-022 | Provider Normalization and Quarantine（提供方归一化与隔离） | PROPOSED | 2026-08-31 | [ADR-022](ADR-022_provider_normalization_quarantine.md)，CR-2（DM-CR-20260831-063）+ CR-2.1 Amendment A（DM-CR-20260831-064：surface identity / immutable registry / full-state replay / atomic commit closure）；复审裁决 pending |
