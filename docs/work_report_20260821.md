...
| 指标 | 数值 |
|---|---|
| 测试总数 | **84 个全部通过**（unit 38 + integration 46）*（2026-08-22 审计整改后已增至 171，见 `docs/audit_response_20260822.md`）* |
| mypy | 21 个源文件，0 错误 |
...
| 探针 | 结果 | 说明 |
|---|---|---|
| 登录认证 | ✅ PASS | TGW 接入服务器（地址见本地 .env / 审计注意 P1-18：版本库不存真实端点），Token 签发，账号参数返回（订阅 100 / 周流量 10GB / 权限码 `3|4|32|33`） |
