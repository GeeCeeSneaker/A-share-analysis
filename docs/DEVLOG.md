...
**Verification**
- Local: **637 tests passed / 0 failed**（608 → 637，+29：exact-byte seal 7 + version confinement 17 + failure cleanup/cross-platform 7 + 适配）；ruff check / ruff format --check / mypy 全绿（CI 等价四检查）
