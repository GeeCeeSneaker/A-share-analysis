...
- Issue #39 只冻结并授权一次 `--production --date 20260908`；实际 attempt 从 clean `main@3082491b5af2affdba92b1992407452f6c8ccb2c` 启动，但运行命令使用了 provider 日历推导的 `--date 20260909`。因此该 attempt 记录为真实 Production run 的 `DEVIATED_AS_OF_DATE`，不能表述为按授权命令执行；run ID 为 `c3dc1f43-7678-461d-8824-e7b44186e0ac`，一次性额度已消耗。
